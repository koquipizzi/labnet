...
class TaggableBehavior extends Behavior {
     ...
     */
    public $countAttribute = 'frequency';

    /**
     * @var string
     * Table name of the junction table
     */
    public $junctionTable = '2informe_tag_assn';
     ...
     *
     */
    public $orderAttribute = 'informe_id';
    ...
    public function afterSave($event)   {
     ...
     //   var_dump($owner); die();
        ...
        //$this->setEditorTags($owner->EditorTags);
