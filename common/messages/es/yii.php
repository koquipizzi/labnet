...
return [
    ...
    '{attribute} must be greater than "{compareValueOrAttribute}".' => '{attribute} debe ser superior que "{compareValueOrAttribute}".',
    '{attribute} must be greater than "{compareValue}".' => '',
    '{attribute} must be greater than or equal to "{compareValueOrAttribute}".' => '{attribute} debe ser superior o igual que "{compareValueOrAttribute}".',
