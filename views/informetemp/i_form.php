...
<div class="informe-form">
  ...
  <?php $form = ActiveForm::begin([            
        ...
        <?php 
            $dataFacturar=ArrayHelper::map(Estudio::find()->asArray()->all(), 'id', 'descripcion');
        ...
        <?= $form->field($informe, 'observaciones', ['template' => "{label}
         ...
         <?= $form->field($informe, 'material', ['template' => "{label}
            <div class='col-md-7'>{input}</div>
            {hint}
            {error}",
            'labelOptions' => [ 'class' => 'col-md-3  control-label' ]
         ...
         <?= $form->field($informe, 'tecnica', ['template' => "{label}
            <div class='col-md-7'>{input}</div>
            {hint}
            {error}",
            'labelOptions' => [ 'class' => 'col-md-3  control-label' ]
         ...
         <?= $form->field($informe, 'macroscopia', ['template' => "{label}
             <div class='col-md-7'>{input}</div>
             {hint}
            {error}",
            'labelOptions' => [ 'class' => 'col-md-3  control-label' ]
           ...
           <?= $form->field($informe, 'microscopia', ['template' => "{label}
            <div class='col-md-7'>{input}</div>
            {hint}
            {error}",
           'labelOptions' => [ 'class' => 'col-md-3  control-label' ]
            ...
            <?= $form->field($informe, 'diagnostico', ['template' => "{label}
                <div class='col-md-7'>{input}</div>
                {hint}
                {error}",
                'labelOptions' => [ 'class' => 'col-md-3  control-label' ]
            ...
            <?= $form->field($informe, 'Informecol', ['template' => "{label}
              <div class='col-md-7'>{input}</div>
              {hint}
              {error}",
                    'labelOptions' => [ 'class' => 'col-md-3  control-label' ]
