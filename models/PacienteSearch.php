    ...
    */
    ...
    public function searchPacPrest($params)
    {
        ...
        $fromTables = "
                    ...
                    (   select
                            CASE   
                                when  Paciente_prestadora.nro_afiliado <> '' then  concat(Prestadoras.descripcion,' - ', Paciente_prestadora.nro_afiliado)
                                else  concat(Prestadoras.descripcion,' - Sin Nro de Afiliado')
