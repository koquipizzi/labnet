...
<div class="paciente-form"> 
   <?php
       $this->registerJsFile('@web/assets/admin/js/cipat_modal_paciente.js', ['depends' => [yii\web\AssetBundle::className()]]);    $this->registerJsFile('@web/assets/admin/js/cipat_modal_paciente.js', ['depends' => [yii\web\AssetBundle::className()]]);
    ...
    <div id="row">
        <div class="col-lg-6">
            ...
            <?= $form->field($model, 'email', ['template' => "{label}
                ...
                <span class='input-group-addon bg-basic' style='padding-left:2px; padding-right:2px;width:5px'>@</span>
                {input}
                </div>
                {hint}
                {error}",
                'labelOptions' => [ 'class' => 'col-md-4  control-label' ],                
            ])->textInput(['maxlength' => true, 'class' => 'cipat-email'])->error([ 'style' => ' margin-left: 35%;']);; ?>
...
//                        $prestadoraTemp = new app\models\PacientePrestadora(); 
                ...
                ?>
                <?= $this->render('//paciente/_grid_select', [
    ...
    <?php use app\assets\admin\dashboard\DashboardAsset;
