            ...
            <tr>
                <td width="400px"  style="padding-top: 0px; padding-left: 20px; float: left;">
                    <table class="header_pap">
                        ...
                        <tr>
                            <td style="white-space:nowrap; width: 3cm; font-weight: bold; font-size: 16px;">DOCUMENTO </td><td  style="font-size: 16px;"><?php echo $modelp->pacienteDoc ? $modelp->pacienteDoc : "Sin datos" ?> </td>
                        </tr>
                        <tr>
                            <td style="white-space:nowrap; width: 3cm; font-weight: bold; font-size: 16px;">EDAD </td><td style="font-size: 16px;"><?php echo $model->edad == 0 ? "Sin datos" : $model->edad; ?> </td>
                        </tr>
                        <tr>
                ...
                <td width="400px" style="margin-left: 20px;padding-top: 0px; float: right;">
                    <table class="header_pap">
                        <tr>
