...
<?php
    ...
    $('#search-field').pressEnter(function() {
        sendPost();
    })
JS;
        ...
        <div class="col-xs-3 form-group">
            <div class="box-footer">
                <div class="input-group">
                        <input id="search-field" type="text" name="q" class="form-control" placeholder="Buscar..." value="<?php if (!empty($searchFeld)){ echo $searchFeld;}?>"/>
