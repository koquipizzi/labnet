...
class m160823_223459_reformulandoViewPacientePrestadora extends Migration
{
    ...
    $this->execute("
        ...
        SELECT p.id , CONCAT(p.nombre,'-',pt.descripcion,'-',pp.nro_afiliado) AS 'nombreDescripcionNroAfiliado',p.nro_documento,p.sexo,p.fecha_nacimiento,p.telefono as 'telefono_paciente',p.email as 'email_paciente',p.Tipo_documento_id,p.Localidad_id AS 'localidad_paciente',p.domicilio as 'domicilo_paciente'
