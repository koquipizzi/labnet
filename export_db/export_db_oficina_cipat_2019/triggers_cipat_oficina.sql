----------------------------------------
triggers cipat oficina
------------------------------------------

DELIMITER $$
CREATE DEFINER='root'@'localhost' TRIGGER bi_protocolo_codigo
            ...
            END
DELIMITER $$
CREATE DEFINER='root'@'localhost' TRIGGER bu_protocolo_codigo
            ...
            END
DELIMITER $$
CREATE DEFINER= 'root'@'localhost' TRIGGER Reset_nro_secuencia
...
DELIMITER $$
CREATE DEFINER='root'@'localhost' TRIGGER ActualizacionEstado_Ins
                            ...
                            END
DELIMITER $$
CREATE DEFINER='root'@'localhost' TRIGGER ActualizacionEstado_Upd
                        ...
                        END
DELIMITER $$
CREATE DEFINER='root'@'localhost' TRIGGER UpdateHistoriaClinica_Dlt
                            ...
                            END
DELIMITER $$
CREATE DEFINER='root'@'localhost' TRIGGER UpdateHistoriaClinica_Upd
