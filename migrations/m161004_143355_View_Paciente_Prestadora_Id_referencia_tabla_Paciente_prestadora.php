...
class m161004_143355_View_Paciente_Prestadora_Id_referencia_tabla_Paciente_prestadora extends Migration
{
    public function safeUp()
    {
        ...
        SELECT pp.id ,CONCAT(p.nombre ,' (',p.nro_documento,')','(',pt.descripcion,'-',pp.nro_afiliado,')') AS 'nombreDniDescripcionNroAfiliado',p.sexo,p.fecha_nacimiento,p.telefono as 'telefono_paciente',p.email as 'email_paciente',p.Tipo_documento_id,p.Localidad_id AS 'localidad_paciente',p.domicilio as 'domicilo_paciente'
