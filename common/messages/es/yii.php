...
return [
    ...
    'Are you sure you want to delete this item?' => '¿Confirma que desea eliminar este item?',
    'Delete' => 'Eliminar',
    'Error' => '',
    'File upload failed.' => 'Error en la carga de archivo',
    'Home' => 'Inicio',
    ...
    '{attribute} is not a valid email address.' => 'No es un mail valido.',
    ...
    '{attribute} must be greater than "{compareValueOrAttribute}".' => '{attribute} debe ser menor que "{compareValueOrAttribute}".',
    '{attribute} must be greater than "{compareValue}".' => '',
    '{attribute} must be greater than or equal to "{compareValueOrAttribute}".' => '{attribute} debe ser mas grande o igual que "{compareValueOrAttribute}".',
    '{attribute} must be greater than or equal to "{compareValue}".' => '{attribute} debe ser mayor o igual que la fecha actual.',
    ...
    '{attribute} should contain at least {min, number} {min, plural, one{character} other{characters}}.' => 'Minimo {min, number} {min, plural, one{caracter} other{caracteres}}. ',
    '{attribute} should contain at most {max, number} {max, plural, one{character} other{characters}}.' => 'Maximo {max, number} {max, plural, one{caracter} other{caracteres}}.',
    ...
    'No results found.' => 'No existen registros.',
    ...
    '{attribute} must be less than or equal to "{compareValue}".' => '{attribute} debe ser anterior o igual a "{compareValue}".',
