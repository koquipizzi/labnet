            ...
            <div class="estudio-view">
                ...
                echo DetailView::widget([
                    ...
                    'attributes' => [
                        ...
                        [
                            'label' => 'Calidad',
                            'value' => $model->descripcionCalidad,
                        ],
                        [
                            'label' => 'Aspecto',
                            'value' => $model->descripcionAspecto,
                        ],
                        [
                            'label' => 'flora',
                            'value' => $model->descripcionFlora,
                        ],
                        [
                            'label' => 'Leucositos',
                            'value' => $model->descripcionLeucositos,
                        ],
                        [
                            'label' => 'Hematies',
                            'value' => $model->descripcionHematies,
                        ],
                        [
                            'label' => 'Otros',
                            'value' => $model->descripcionOtros,
                        ],
                        [
                            'label' => 'Microorganismos',
                            'value' => $model->descripcionMicroorganismos,
                        ],
