...
<section id="page-content">
    ...
    <div class="body-content animated fadeIn" >
        <div class="panel rounded shadow">
            <div class="tipo-prestadora-view">
                <div class="panel-heading">
                    <h3 class="panel-title text-center"><?= Html::encode($this->title) ?>

                        <p style="float: right;">
                        <?=                             Html::a('<span class="fa fa-pencil"></span>', 'index.php?r=tipo-prestadora/update&id='.$model->id, [
                            'title' => Yii::t('app', ' Editar '),
                            'class'=>'btn btn-info btn-xs',                                  
                ]); ?>
                        <?=                             Html::a('<span class="fa fa-trash "></span>', 'index.php?r=tipo-prestadora/delete&id='.$model->id, [
